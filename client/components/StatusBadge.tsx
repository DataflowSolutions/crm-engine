...
export default function StatusBadge({ status }: { status: StatusType }) {
  ...
  const translationMap: Record<StatusType, string> = {
    ...
    Ska_ringa: t("Orgs.leads.badges.should_call"),
    ...
    should_call: t("Orgs.leads.badges.should_call"),
